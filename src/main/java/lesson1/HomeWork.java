...
public class HomeWork {
    public static void main(String[] args) {
        ...
        changeArraysElements(array);
        System.out.println();

        //Task 2
        List<String> list = new ArrayList<>();
        convertArrayToArrayList(array, list);
        System.out.println();
    ...
    public static <T> void changeArraysElements(T[] array) {
    ...
    public static <E> void convertArrayToArrayList(E[] array, List<E> list) {
